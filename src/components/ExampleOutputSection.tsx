    ...
    <section id="example-output" className="py-20 bg-accent/30" ref={sectionRef}>
      <div className="container px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tighter mb-2">🧠 Example Output</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch max-w-7xl mx-auto">
          <div className="flex-1 flex flex-col">
            <Tabs defaultValue="issue" value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="issue" className="border rounded-lg shadow-sm">
              ...
              <TabsContent value="terminal" className="min-h-[500px] border rounded-lg shadow-sm bg-card p-4">
              ...
              <TabsContent value="prompt" className="min-h-[500px] border rounded-lg shadow-sm bg-card">
            ...
            <div className="flex justify-center mt-4">
              <div className="flex items-center space-x-6 text-center">
                <Button 
                  ...
                  className={`flex flex-col items-center ${activeTab === "issue" ? "border-brand-purple text-brand-purple" : ""}`}
                >
                ...
                <Button 
                  ...
                  className={`flex flex-col items-center ${activeTab === "terminal" ? "border-brand-purple text-brand-purple" : ""}`}
                >
                  <div className="h-10 w-10 rounded-full bg-accent flex items-center justify-center mb-2">
                    <Terminal size={20} />
                  </div>
                ...
                <Button 
                  ...
                  className={`flex flex-col items-center ${activeTab === "prompt" ? "border-brand-purple text-brand-purple" : ""}`}
                >
                  <div className="h-10 w-10 rounded-full bg-accent flex items-center justify-center mb-2">
