              ...
              <div className="flex items-center gap-3">
                {progress.status === 'error' ? <AlertCircle className="h-5 w-5 text-red-400 flex-shrink-0" />
                  ...
                  : <div className="h-5 w-5 flex-shrink-0 relative">
                      <div className="h-5 w-5 border-2 border-blue-400/30 border-t-blue-400 rounded-full animate-spin"></div>
                    </div>}
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Status: {progress.status}</p>
                </div>
              </div>
